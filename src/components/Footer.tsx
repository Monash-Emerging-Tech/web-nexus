  ...
  return (
    <footer style={{
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <a data-ccursor href="https://discord.gg/Xjmk4YurEJ" style={{ color: 'white', fontSize: '1.5em' }} aria-label="Discord"><DiscordIcon className="w-[1.2em] h-[1em] inline-block align-[-0.125em]" /></a>
      </div>
