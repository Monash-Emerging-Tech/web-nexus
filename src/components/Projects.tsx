...
const projectsData = [
  {
    ...
    description: 'Building a digital twin of a wastewater treatment pilot plant.',
  ...
  },
  {
    ...
    description: 'Digital archive of temples and lontar manuscripts for preservation.',
  ...
  },
  {
    ...
    description: "Visualising MBEST's Tunnel Boring Machine operations and data.",
