...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="w-full h-full">
      {open ? (
        <div className="absolute z-10 top-0 left-0 w-full h-full bg-black opacity-90">
          <div className="absolute right-4 top-36 bg-gradient-to-b from-[#030CAB] to-[#DC003B] p-0.5 rounded-3xl">
